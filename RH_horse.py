...
# I will hit up each group individually after round one and get you set for round 2.
 # player 1 
 # player 2
 # input random for shots
 # keep track of letters
 # if player makes shot
 # if player misses shot it will return a letter    
 # value will change if player misses shot they will get new letter 
 # function will be needed to dicide which player will shoot